...
#+RESULTS:
| [main   | 97901e7] | commit   | de | actualización  | por | defecto      | para | pequeñas | modificaciones |
...
#+begin_src emacs-lisp
  ...
  (setq initial-scratch-message ";; ようこそルーカス、長生きする自由な知識とパリアの人々!\n\n\n")
#+end_src
...
#+begin_src emacs-lisp
      ...
      (use-package toggle-theme
        :config
        (setq toggle-theme--light-theme 'leuven
              toggle-theme--dark-theme 'leuven-dark)
        :bind
